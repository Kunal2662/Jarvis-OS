 ...
 * (`stores/startup-preferences.store.ts`) or the OS reports
 * `prefers-reduced-motion`, per the accessibility requirement that
 * disabling the animation launches straight into the dashboard.
 */
export function StartupGate() {
  const skipPreference = useStartupPreferencesStore((s) => s.skipStartupAnimation);
